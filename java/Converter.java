...
//        this.casm_f = 0;
    ...
    static protected double yj_sin2(double x)
    {
    	double tt;
    	double ss;
    	double ff;
    ...
    static protected double Transform_yj5(double x, double y)
    {
        double tt;
    ...
    static protected double Transform_yjy5(double x,double y)
    {
        double tt;
    ...
    static protected double Transform_jy5(double x, double xx)
    {
        double n;
        double a;
        double e;
    ...
    static protected double Transform_jyj5(double x,double yy)
    {
        double m;
        double a;
        double e;
    ...
    static protected double random_yj()
    {
        double t;
    ...
    static protected void IniCasm(double w_time, double w_lng, double w_lat)
    {
        double tt;
        casm_t1 = w_time;
        casm_t2 = w_time;
    ...
    static protected Point wgtochina_lb(int wg_flag,int wg_lng, int wg_lat, int wg_heit, int wg_week, int wg_time)
    {
    	double  x_add;
    	double  y_add;
    	double  h_add;
    ...
    static public Point getEncryPoint(double x,double y)
    {
